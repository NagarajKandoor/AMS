<%-- 
    Document   : deleteexam
    Created on : May 2, 2014, 1:16:53 AM
    Author     : nagaraj
--%>
...
//Fetch parameter coming from previous page 
    ...
    {
        try{
    var_categoryid=request.getParameter("edate");
    
   
    stmt = conn.prepareStatement("delete from exam where edate=?");
...
<html>
    ...
    <link rel="stylesheet" href="runnable.css" />
     ...
     <body bgcolor="#FFFFCC">
       <form action="deleteexam.jsp" method="post" >
            <table width="98">
            ...
            <table border="1" align="center" bordercolor="blue">
                <tr>   <td align="center" colspan="4">Delete-Exam</td></tr>
                <tr>
                    <td>E-Date:*</td><td><input type="text" id="datepicker" name="edate"  maxlength="10" min="10" required="" placeholder="Enter E-Date" 
