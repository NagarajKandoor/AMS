<%-- 
    ...
    Created on : May 2, 2014, 6:23:28 AM
    Author     : nagaraj
--%>
...
//Fetch parameter coming from previous page 
    ...
    {
        try{
    var_categoryid=request.getParameter("fid");
    
   
    stmt = conn.prepareStatement("delete from faculty where fid=?");
     ...
     <body bgcolor="#FFFFCC">
         <form action="deletefaculty.jsp" method="post" >
            ...
            <table border="1" align="center" bordercolor="blue">
                <tr>   <td align="center" colspan="4">Delete-Faculty</td></tr>
                <tr>
                    <td>F-ID:*</td><td><input name="fid"  maxlength="10" min="10" required="" placeholder="Enter Fid" 
