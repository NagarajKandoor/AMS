<%-- 
    ...
    Created on : May 2, 2014, 6:39:06 AM
    Author     : nagaraj
--%>
...
//Fetch parameter coming from previous page 
    ...
    {
        try{
    var_categoryid=request.getParameter("cid");
     ...
     <body bgcolor="#FFFFCC">
         <form action="deletecourse.jsp" method="post" >
            ...
            <table border="1" align="center" bordercolor="blue">
                <tr>   <td align="center" colspan="4">Delete-Course</td></tr>
                <tr>
                    <td>C-ID:*</td><td><input name="cid"  maxlength="10" min="10" required="" placeholder="Enter Cid" 
