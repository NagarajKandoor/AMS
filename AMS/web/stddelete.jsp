<%-- 
    Document   : stddelete
    Created on : May 1, 2014, 1:33:24 AM
    Author     : nagaraj
--%>
...
<html>
    <head>
     ...
     <body bgcolor="#FFFFCC">
       <form action="stddelete.jsp" method="post" >
            <table width="98">
            ...
            <table border="1" align="center" bordercolor="blue">
                <tr>   <td align="center" colspan="4">Student</td></tr>
                <tr>
                    <td>USN:*</td><td><input type="text" name="usn"  maxlength="10" min="1" required="" placeholder="Enter usn" 
